...
def calculate_accuracy(prediction_file, true_labels):
    ...
    with open(prediction_file, 'r', encoding='utf-8') as f:
        ...
        for row, true_label in zip(reader, true_labels):
            predicted_label =row['prediction']  # 预测标签
...
# 示例调用
text_file = 'data/wjh/graduate/AugData/SciTail/scitail_1.0_test.tsv'  # 真实标签文件
prediction_file = 'data/wjh/graduate/data/submit/SciTail.tsv'  # 预测文件
